...
type SendFileToMythicStruct struct {
	...
	// the following are set and used by Freyja, Task doesn't use
	// two components used by Freyja internally to track and handle chunk responses from Mythic for this specific file transfer
	TrackingUUID         string
