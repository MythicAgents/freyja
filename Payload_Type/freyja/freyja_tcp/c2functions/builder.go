...
var freyjaTCPC2definition = c2structs.C2Profile{
	Name:           "freyja_tcp",
	...
	SampleMessageFunction: func(message c2structs.C2SampleMessageMessage) c2structs.C2SampleMessageResponse {
		...
		response.Message = fmt.Sprintf("freyja_tcp messages are formatted as follows:\n")
...
var freyjaTCPC2parameters = []c2structs.C2Parameter{
	{
		Name:          "port",
...
func Initialize() {
	c2structs.AllC2Data.Get("freyja_tcp").AddC2Definition(freyjaTCPC2definition)
	c2structs.AllC2Data.Get("freyja_tcp").AddParameters(freyjaTCPC2parameters)
}
