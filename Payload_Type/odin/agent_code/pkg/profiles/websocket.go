...
import (
	...
	// odin
	"github.com/MythicAgents/odin/Payload_Type/odin/agent_code/pkg/utils/crypto"
...
// encrypted_exchange_check is set to True or False to determine if odin should do a key exchange
